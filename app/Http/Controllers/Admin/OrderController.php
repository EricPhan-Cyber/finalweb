...
class OrderController extends Controller
{
    public function index(Request $request)
    {
        ...
        // select coloumn from current date
    ...
    public function show(int $orderId)
    {
        ...
        if ($order) {
            ...
            return redirect('admin/orders')->with('message', 'Orders Id not found');
        }
    }
    ...
    public function update(int $orderId, Request $request)
    {
        ...
        if ($order) {
            ...
            return redirect('admin/orders/' . $orderId)->with('message', 'Orders Id not found');
        }
    }
